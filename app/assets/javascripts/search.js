$(function(){
  ...
  var book_info = {};
  var book_id = 0;
  //function to show a book after search
  function display_book(response){
  ...
  //function for getting a book from google books API
  function google_for_book(){
